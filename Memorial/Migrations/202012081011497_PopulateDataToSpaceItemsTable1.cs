namespace Memorial.Migrations
{
    ...
    public partial class PopulateDataToSpaceItemsTable1 : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                ...
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (21,'Free',0,'False','False',2,'SFE01',1); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (22,'Free',0,'False','False',2,'SFE02',2); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (23,'Free',0,'False','False',2,'SFE03',3); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (24,'Free',0,'False','False',2,'SFE04',4); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (25,'Free',0,'False','False',2,'SFE05',5); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (26,'Free',0,'False','False',2,'SFE06',6); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (27,'Free',0,'False','False',2,'SFE07',7); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (28,'Free',0,'False','False',2,'SFE08',8); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (29,'Free',0,'False','False',2,'SFE09',9); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (30,'Free',0,'False','False',2,'SFE10',10); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
                "INSERT INTO SpaceItems(Id,Name,Price,AllowDeposit,AllowDoubleBook,ToleranceHour,Code,SpaceId) VALUES (31,'Free',0,'False','False',2,'SFE11',11); " +
                "SET IDENTITY_INSERT SpaceItems OFF;");
            Sql("SET IDENTITY_INSERT SpaceItems ON; " +
